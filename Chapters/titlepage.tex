...
\begin{center}
    {\setstretch{1.66} { ON THE REQUIREMENTS FOR A COMPLETE RF TRANSMIT COIL AT ULTRAHIGH FIELD FOR HEAD IMAGING }\par}
    \vskip .4in
    By
    \vskip .3in
    { Benjamin Michael Hardy }
    \vskip .3in
